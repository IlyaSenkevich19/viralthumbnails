...
export class StorageService {
  ...
  /**
   * Short-lived upload so OpenRouter (or other servers) can fetch the file via signed URL.
   * Caller should remove the object after processing.
   */
  async uploadTemporaryVideoForAnalysis(params: {
    userId: string;
    runId: string;
    body: Buffer;
    contentType: string;
