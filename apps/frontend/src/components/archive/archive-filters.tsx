...
const SORT_OPTIONS = [
  { id: 'processed', label: 'Recently processed' },
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm font-medium text-slate-700">
          {totalCount} {totalCount === 1 ? 'item' : 'items'} in archive
        </p>
        <div className="relative" ref={sortRef}>
          ...
          {sortOpen && (
            <div
              className="absolute right-0 top-full z-50 mt-1 min-w-[180px] overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg"
              role="listbox"
            >
              {SORT_OPTIONS.map((s) => (
                <button
